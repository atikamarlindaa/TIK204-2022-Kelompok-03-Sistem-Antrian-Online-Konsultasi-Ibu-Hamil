                            ...
                            ?>
                              <tr>
                                ...
                                <td><?php
                                    ...
                                    <form action="detail_usg_admin.php" method="POST">
                                      <input type="hidden" name="id" value="<?php echo $idnama; ?>">
                                      <input type="hidden" name="idriwayat" value="<?php echo $idpenyakit ?>">
                                      <button type="submit" title="Detail Foto USG Pasien" data-toggle="tooltip" id="btn-link"><i class="fas fa-info-circle text-info"></i> <?php echo $jumrotgen; ?> Foto</button>
                                    </form>
                                  <?php } ?>
                                </td>
                                <td>
