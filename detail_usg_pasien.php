...
<head>
  ...
  $idnama = $_POST['id'];
  $page1 = "detrot";
  $page = "Foto Hasil USG Pasien : " . $idnama;
  session_start();
  ...
  $sqlimg = mysqli_query($conn, "SELECT * FROM foto_usg WHERE id_pasien='$idid' AND id_penyakit='$idpenyakit'");
      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Foto Hasil USG Pasien</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="riwayat_pasien.php">Foto Hasil USG</a></div>
              <div class="breadcrumb-item">Foto Hasil USG : <?php echo ucwords($idnama); ?></div>
            </div>
          </div>
            ...
            <div class="section-body">
                    ...
                    <div class="card-header">
                      ...
                      <div class="card-header-action">
                        <form method="POST" action="print.php" target="_blank">
                          ...
                          <a href="antrian_pasien.php" class="btn btn-primary">Antrian</a>
                        </form>
                      </div>
                    </div>
                    <div class="card-body">
              ...
              <div class="row">
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      <h4>Semua Foto Hasil USG Penyakit : <?php echo $echopen['penyakit']; ?></h4>
                    </div>
                    <div class="card-body">
