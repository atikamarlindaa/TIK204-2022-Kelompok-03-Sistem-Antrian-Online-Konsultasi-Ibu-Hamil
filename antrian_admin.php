              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Pasien yang telah mengambil antrian</h4>
                  </div>
                  <div class="card-body">
                          ...
                          ?>
                            <tr>
                              ...
                              <td>
                                  ...
                                  <a class="btn btn-danger btn-action mr-1" data-toggle="tooltip" title="Hapus" data-confirm="Hapus Data|Apakah anda ingin menghapus data ini?" data-confirm-yes="window.location.href = 'auth/delete_admin.php?type=antrian&id=<?php echo $row['id']; ?>'" ;><i class="fas fa-trash"></i></a>
                            </td>
                            </tr>
                          <?php } ?>
                        </tbody>
