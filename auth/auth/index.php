...
<section class="smart-scroll">
    <div class="container-fluid">
        <nav class="navbar navbar-expand-md navbar-dark">
            <a class="navbar-brand heading-black text-info" href="landing_page.php">
                PRECONS
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link page-scroll d-flex flex-row align-items-center text-info" href="#features">Features</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link page-scroll d-flex flex-row align-items-center text-info" href="#">
    ...
    <div class="container">
        <div class="row vh-md-100">
            <div class="col-md-8 col-sm-10 col-12 mx-auto my-auto text-center">
                ...
                <h5>Sistem Antrian Online Konsultasi Ibu Hamil</h5>
                <p class="lead py-3">Sistem Antrian Online Konsultasi Ibu Hamil merupakan sistem yang mampu mengambil antrian untuk konsultasi ibu hamil</p>
                <a href="login_admin.php"><button class="btn btn-info d-inline-flex flex-row align-items-center">
                    Login for Doctor
                    <em class="ml-2" data-feather="arrow-right"></em>
                </button></a>
                <a href="login_pasien.php"><button class="btn btn-info d-inline-flex flex-row align-items-center">
                    Login for Pasien
                    <em class="ml-2" data-feather="arrow-right"></em>
                </button></a>
            </div>
...
<footer class="py-6">
    <div class="container">
        <div class="row">
            <div class="col-md-6 mx-auto text-center">
                <h5>About PreCons</h5>
                <p class="text-muted">Website ini memiliki beberapa fitur yang bisa digunakan sesuai kebutuhan pengguna</p>
        ...
        <div class="row mt-5">
            <div class="col-12 text-muted text-center small-xl">
                ...
                <br><center><p>Sistem Antrian Online Konsultasi Ibu Hamil</a></p></center>
            </div>
        </div>
    </div>
</footer>
